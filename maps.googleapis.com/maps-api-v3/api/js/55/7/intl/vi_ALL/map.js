google.maps.__gjsload__('map', function(_) {
    var yia = function(a) {
        ...
        ZD = function(a, b, c, d = {
            ...
            return new _.TC(_.dA(a.Qg), "Xin l\u1ed7i, ch\u00fang t\u00f4i kh\u00f4ng c\u00f3 h\u00ecnh \u1ea3nh \u1edf \u0111\u00e2y.",
        ...
        jja = function(a, b) {
            return new $D(ija(a), a.Ig, "number" === typeof b ? new _.Rt(b) : a.Mg, "number" === typeof b ? 21 : 22, "K\u1ebft h\u1ee3p", "Hi\u1ec3n th\u1ecb h\u00ecnh \u1ea3nh c\u00f3 t\u00ean ph\u1ed1", _.IA.hybrid, "m@" + a.Pg, {
                type: 68,
                params: {
        ...
        lja = function(a, b) {
            ...
            return new $D(kja(a),
                null, "number" === typeof b ? new _.Rt(b) : a.Mg, c ? 21 : 22, "V\u1ec7 tinh", "Hi\u1ec3n th\u1ecb h\u00ecnh \u1ea3nh qua v\u1ec7 tinh", c ? "a" : _.IA.satellite, null, null, "satellite", a.Og, a.Jg, a.Ng, b, a.Kg)
        },
        mja = function(a, b) {
        ...
        nja = function(a, b, c = {}) {
            ...
            } else b = "roadmap" == b && 1 < _.Oo() && c.SE ? new $D(hja(a), a.Ig, a.Mg, 22, "B\u1ea3n \u0111\u1ed3",
                "Hi\u1ec3n th\u1ecb b\u1ea3n \u0111\u1ed3 ph\u1ed1", _.IA.roadmap, "m@" + a.Pg, {
                    type: 68,
                    params: {
                        set: "Roadmap"
                    }
                }, "roadmap", a.Og, a.Jg, a.Ng, void 0, a.Kg) : "terrain" == b ? new $D(mja(a, "terrain"), a.Ig, a.Mg, 21, "\u0110\u1ecba h\u00ecnh", "Hi\u1ec3n th\u1ecb b\u1ea3n \u0111\u1ed3 ph\u1ed1 v\u1edbi \u0111\u1ecba h\u00ecnh", _.IA.terrain, "r@" + a.Pg, {
                type: 68,
                params: {
                    set: "Terrain"
                }
            }, "terrain", a.Og, a.Jg, a.Ng, void 0, a.Kg) : new $D(mja(a, "roadmap"), a.Ig, a.Mg, 22, "B\u1ea3n \u0111\u1ed3", "Hi\u1ec3n th\u1ecb b\u1ea3n \u0111\u1ed3 ph\u1ed1",
                _.IA.roadmap, "m@" + a.Pg, {
                    type: 68,
                    params: {
                        set: "Roadmap"
        ...
        oja = function(a, b = !1) {
            const c = _.on.Sg ? "S\u1eed d\u1ee5ng \u2318 + cu\u1ed9n \u0111\u1ec3 thu ph\u00f3ng b\u1ea3n \u0111\u1ed3" : "S\u1eed d\u1ee5ng ctrl + cu\u1ed9n \u0111\u1ec3 thu ph\u00f3ng b\u1ea3n \u0111\u1ed3";
            a.Qg.textContent = b ? c : "S\u1eed d\u1ee5ng hai ng\u00f3n tay \u0111\u1ec3 di chuy\u1ec3n b\u1ea3n \u0111\u1ed3";
            a.fh.style.transitionDuration = "0.3s";
            a.fh.style.opacity = 1
        },
        pja = function(a) {
            a.fh.style.transitionDuration =
                "0.8s";
        ...
        uja = function(a, b, c, d, e) {
            ...
            l = !!d && !!window.MSPointerEvent && d.pointerType === window.MSPointerEvent.MSPOINTER_TYPE_TOUCH; {
                ...
                if (l != f.Jg || q != f.Ng) f.Jg && f.Jg.handleEvent("mouseout", c, f.Ng), f.Jg = l, f.Ng = q, l && l.handleEvent("mouseover", c, q);
                l ? "mouseover" == g || "mouseout" == g ? q = !1 : (l.handleEvent(g,
                    c, q), q = !0) : q = !!w
            }
        ...
        bE = function(a, b, c) {
            function d() {
                var l = a.__gm,
                    n = l.get("baseMapType");
                n &&
                    !n.Iq && (0 !== a.getTilt() && a.setTilt(0), 0 != a.getHeading() && a.setHeading(0));
                ...
                if (_.dj(t) && u) {
                    ...
                    l.get("isInitialized") && u && w && t && t === a.getZoom() ?
                        (l = _.ps(q, _.Tt(w, n)), n = _.ps(q, _.Tt(u, n)), a.panBy(n.ih - l.ih, n.lh - l.lh)) : (a.setCenter(u), a.setZoom(t))
                }
            }
            let e = 80,
                f = 80,
        ...
        zja = function(a, b) {
            for (let c =
                    0; c < a.Ig.length; ++c) c !== b && a.Ig[c].setZIndex(c)
        },
        ...
        Uja = function(a) {
            ...
            for (const g of a) {
                ...
                const h = Via(c);
                h && f.push("s.t:" + h);
                null != c && null == h && _.qj(_.pj(`invalid style feature type: ${c}`, null));
                ...
                if (e)
                    for (const l of e) {
                        a: {
                            for (const n in l)
                                if (d =
                                    l[n], (e = n && Tja[n.toLowerCase()] || null) && (_.dj(d) || _.gj(d) || _.hj(d)) && d) {
                                    d = "p." + e + ":" + d;
                                    break a
                                }
                            d = void 0
        ...
        Yja = function(a) {
            ...
            a = _.J(a.Lg, 2, _.Du);
            return _.gl(_.xu(b.Lg, 1), _.xu(b.Lg,
                2), _.xu(a.Lg, 1), _.xu(a.Lg, 2))
        },
        Zja = function(a) {
            let b;
            const c = jE(a);
        ...
        nE = function(a, b) {
            if (!a.Kg || a.Kg === b) {
                var c = b === a.Jg;
                const d = b.yo();
                d && a.Ig.has(d) ? lE(a, b, c) : (mE(a, b, c), b = a.Ig.values().next().value,
                    lE(a, b, c))
            }
        },
        oE = function(a, b) {
        ...
        cka = function(a, b) {
            ...
            0 < c.length ? b.targetElement.setAttribute("aria-describedby", c.join(" ")) :
        ...
        mE = function(a, b, c = !1) {
            b && b.targetElement && (b = b.yo(), b.setAttribute("tabindex", "-1"), c && b.blur(), a.Kg = null, a.Jg = null)
        },
        pE = function(a) {
            this.Ig = a
        },
        dka = function(a, b) {
            ...
            for (const e of c.Ng.keys()) c.Ng.get(e).isEnabled =
                d.includes(e);
        ...
        rE = function(a, b) {
            ...
            a && (this.Ig = _.lu(this.Jg).createElement("div"), this.Ig.style.width = "1px", this.Ig.style.height = "1px", _.ru(this.Ig, 1E3));
            this.Jg = b;
            ...
            if (!_.gs(b)) {
                ...
                if (!1 !== c) {
                    ...
                    if ("none" !== c && ("cooperative" !== c || !d)) {
                        ...
                        else if (a.Jg = e, a.Ig += e, a.Mg.Ej(), e = a.oh.rk(), d || !(16 > Math.abs(a.Ig))) {
                            if (d) {
        ...
        uka = function(a, b, c, d) {
            ...
            a.options.tv || (a.Kg.style.willChange =
                a.Mg.style.willChange = "");
        ...
        Jka = function(a) {
            ...
            if (b) {
                const c = function() {
                    for (; b.getLength();) {
                        const d = b.pop();
                        "string" === typeof d ? _.wl(a, d) : "number" ===
                            typeof d && _.ul(a, d)
                    }
                };
                _.ok(b, "insert_at", c);
        ...
        Kka = function(a) {
            ...
            if (b) {
                ...
                _.ok(b, "insert_at", c);
                c()
            } else _.yk(a, "embedfeaturelog_changed",
                function() {
                    Kka(a)
                })
        },
        ...
        eja = class {
            constructor(a, b, c, d, e, f, g = !1, h) {
                this.Mg = "Xin l\u1ed7i, ch\u00fang t\u00f4i kh\u00f4ng c\u00f3 h\u00ecnh \u1ea3nh \u1edf \u0111\u00e2y.";
                this.Ig = a || [];
                this.Qg =
                    new _.Fl(e.size.ih, e.size.lh);
                this.Rg = b;
                this.Jg = c;
                this.Pg = d;
                this.Qk = 1;
        ...
        Zka = class {
            ...
            show(a) {
                ...
                if (!this.Ig.has(b)) {
                    ...
                    d.textContent = "Trang n\u00e0y kh\u00f4ng th\u1ec3 t\u1ea3i Google Maps \u0111\u00fang c\u00e1ch.";
    ...
    var kla = class {
        ...
        set Xg(a) {
            ...
            b.id = this.Ng;
            b.textContent = "\u0110\u1ec3 \u0111i theo ch\u1ec9 d\u1eabn, h\u00e3y nh\u1ea5n c\u00e1c ph\u00edm m\u0169i t\u00ean.";
    ...
    xE.prototype.Ig = function(a, b, c, d, e, f) {
        ...
        if (n)
            if (42 !== Array.from(new Set([42]))[0]) _.Jz(n);
                ...
                x.textContent = "\u0110\u1ec3 di chuy\u1ec3n b\u1ea3n \u0111\u1ed3 b\u1eb1ng c\u1eed ch\u1ec9 ch\u1ea1m, h\u00e3y nh\u1ea5n \u0111\u00fap v\u00e0 gi\u1eef ng\u00f3n tay c\u1ee7a b\u1ea1n tr\u00ean b\u1ea3n \u0111\u1ed3, sau \u0111\u00f3 k\u00e9o b\u1ea3n \u0111\u1ed3.";
                ...
                h.set("interactiveContainer", q.Rj);
                ...
                h.Qg.then(Fa => {
                    a.get("webgl") && _.mn[15] || Kia(Fa) ? (_.wl(a,
                        "Wma"), _.ul(a, 150152), _.fk("webgl").then(bb => {
                        let ob, Kc = !1;
                        ...
                        try {
                            ...
                            Kc ? (h.Xg(!1), _.jj("Attempted to load a Vector Map, but failed. Falling back to Raster. Please see https://developers.google.com/maps/documentation/javascript/webgl/support for more info")) :
                                (_.rl($b, 0), h.Xg(!0), h.Li = ob, h.set("configVersion", ob.Sg()), Cb.My(ob.Tg()))
                        }
                    })) : h.Xg(!1)
                });
                h.Mg.then(Fa => {
                ...
                var ua = new _.$B(a, Cb, function() {
                        ...
                        if (ua.Ng && ua.Mg && ua.Ig && ua.Kg && ua.Jg) {
                            if (ua.Ig.Ig) {
                                ...
                                _.ps(ua.Ig, _.ls(ua.Ng.min, ua.Mg)), bb = _.ps(ua.Ig, _.ls(ua.Ng.max, ua.Mg)), ob = new _.Dl(ob.ih, ob.lh), bb = new _.Dl(bb.ih, bb.lh);
                            ob = new _.xm([ob, bb])
                        } else ob = null;
                ...
                e = new Qka(_.Ji(_.Ri.Lg, 2, _.bA), _.es(), _.Ri.Ig(),
                    a, new dE(C, function(Fa) {
                        return W ? X : Fa || M
                    }), B.obliques, f, h.Ig);
                ...
                wja((Fa, bb) => {
                    _.wl(a, Fa);
                    _.ul(a, bb)
                }, q.ql.mapPane, a.overlayMapTypes, Cb, b, Ea);
                ...
                _.vk(Cc, "load", () => {
                    xd();
                    _.vk(Cc.contentWindow, "resize", xd)
                });
                q.Ig.appendChild(Cc);
                b = _.or(q.Rj);
                q.Ig.appendChild(b);
